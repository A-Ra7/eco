...
function endGame() {
    ...
    alert(`Время вышло! \n\nТы собрал ${score} из 50 единиц мусора. \n\nНадо собрать весь мусор. Попробуй еще раз :-)`);
}
...
function victory() {
    ...
    alert(`Поздравляем! Ты собрал весь мусор. \n\nВремя: ${60 - timeLeft} секунд - Очки: ${score} \n\nТеперь собери немного настоящего мусора и сделай мир чище :-)`);
}
